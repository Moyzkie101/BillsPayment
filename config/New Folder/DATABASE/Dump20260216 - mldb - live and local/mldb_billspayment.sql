...
--
-- Dumping data for table `billspayment`
--

LOCK TABLES `billspayment` WRITE;
/*!40000 ALTER TABLE `billspayment` DISABLE KEYS */;
/*!40000 ALTER TABLE `billspayment` ENABLE KEYS */;
UNLOCK TABLES;
