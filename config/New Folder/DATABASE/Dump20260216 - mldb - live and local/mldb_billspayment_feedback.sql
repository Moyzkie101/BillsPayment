...
--
-- Dumping data for table `billspayment_feedback`
--

LOCK TABLES `billspayment_feedback` WRITE;
/*!40000 ALTER TABLE `billspayment_feedback` DISABLE KEYS */;
/*!40000 ALTER TABLE `billspayment_feedback` ENABLE KEYS */;
UNLOCK TABLES;
