...
--
-- Table structure for table `billspayment_others`
--

DROP TABLE IF EXISTS `billspayment_others`;
...
--
-- Dumping data for table `billspayment_others`
--

LOCK TABLES `billspayment_others` WRITE;
/*!40000 ALTER TABLE `billspayment_others` DISABLE KEYS */;
/*!40000 ALTER TABLE `billspayment_others` ENABLE KEYS */;
UNLOCK TABLES;
