...
--
-- Table structure for table `temp_billspayment`
--

DROP TABLE IF EXISTS `temp_billspayment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `temp_billspayment` (
  `id` int NOT NULL AUTO_INCREMENT,
  `status` varchar(15) DEFAULT NULL,
  `cancellation_date` varchar(150) DEFAULT NULL,
  ...
  `contact_number` char(25) DEFAULT NULL,
...
--
-- Dumping data for table `temp_billspayment`
--

LOCK TABLES `temp_billspayment` WRITE;
/*!40000 ALTER TABLE `temp_billspayment` DISABLE KEYS */;
/*!40000 ALTER TABLE `temp_billspayment` ENABLE KEYS */;
UNLOCK TABLES;
