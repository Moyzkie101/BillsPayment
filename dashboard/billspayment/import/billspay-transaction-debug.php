        ...
        <div class="bp-card container-fluid mt-3 p-4">
            <div class="bp-card-body">
                ...
                <div id="manualArea" style="display:none;">
                    <form id="manualUploadForm" action="../../../models/saved/saved_billspaymentImportFile-debug.php" method="post" enctype="multipart/form-data">
                        <div class="row mt-3">
                        ...
                        <p><small>This portion is <b>TEMPORARILY UNDER CONSTRUCTION</b></small></p>
                    </form>
                </div>
    ...
    <script>
        ...
        $(function() {
            ...
            async function proceedWithManualUpload(form, userDecision) {
                ...
                tempForm.action = '../../../models/saved/saved_billspaymentImportFile-debug.php';
