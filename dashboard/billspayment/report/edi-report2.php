                                        ...
                                        <div class="card mb-4 h-100" id="filterResultCard">
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-5"><strong>Transaction Date:</strong></div>
                                                        <div class="col-7"><span id="filterTransactionDate" class="text-muted">-</span></div>
                                                    </div>
    ...
    window.updateDataTable = function(data, totalCharges) {
        ...
        if (data && Array.isArray(data) && data.length > 0) {
            data.forEach(function(row) {
                const zone = row.zone || row.ml_matic_region || row.zone_code || '-';
                const region = row.region || row.region_code || row.region_description || '-';
