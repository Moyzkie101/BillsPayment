...
<body>
    ...
    <script>
                    ...
                    <div class="border rounded p-3 mb-3 bg-light-subtle">
                        ...
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select edit-reason-note" data-reference="${reference}">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6">
                                <div class="border rounded p-3 h-100 bg-white">
                                    ...
                                    <div class="mb-2"><label class="form-label mb-1">Payor</label><input type="text" class="form-control" value="${escapeModalValue(row.payor)}" readonly></div>
                                    <div class="mb-2"><label class="form-label mb-1">Address</label><input type="text" class="form-control" value="${escapeModalValue(row.address)}" readonly></div>
                                    <div class="mb-2"><label class="form-label mb-1">Account No</label><input type="text" class="form-control" value="${escapeModalValue(row.accountNo)}" readonly></div>
                                    ...
                                    <div class="mb-2"><label class="form-label mb-1">Amount Paid</label><input type="text" class="form-control" value="${escapeModalValue(row.amountPaid)}" readonly></div>
                                    ...
                                    <div class="mb-2"><label class="form-label mb-1">Contact No</label><input type="text" class="form-control" value="${escapeModalValue(row.contactNo)}" readonly></div>
                                    ...
                                    <div class="mb-2"><label class="form-label mb-1">ML Outlet</label><input type="text" class="form-control" value="${escapeModalValue(row.mlOutlet)}" readonly></div>
                                    <div class="mb-0"><label class="form-label mb-1">Operator</label><input type="text" class="form-control" value="${escapeModalValue(row.operator)}" readonly></div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="border rounded p-3 h-100 bg-white">
                                    ...
                                    <div class="mb-2"><label class="form-label mb-1">Payor</label><input type="text" class="form-control edit-payor" data-reference="${reference}" value="${escapeModalValue(row.payor)}"></div>
                                    <div class="mb-2"><label class="form-label mb-1">Address</label><input type="text" class="form-control edit-address" data-reference="${reference}" value="${escapeModalValue(row.address)}"></div>
                                    <div class="mb-2"><label class="form-label mb-1">Account No</label><input type="text" class="form-control edit-account-no" data-reference="${reference}" value="${escapeModalValue(row.accountNo)}"></div>
                                    <div class="mb-2"><label class="form-label mb-1">Account Name</label><input type="text" class="form-control edit-account-name" data-reference="${reference}" value="${escapeModalValue(row.accountName)}"></div>
                                    <div class="mb-2"><label class="form-label mb-1">Amount Paid</label><input type="text" class="form-control edit-amount-paid" data-reference="${reference}" value="${escapeModalValue(row.amountPaid)}"></div>
                                    <div class="mb-2"><label class="form-label mb-1">Charge to Customer</label><input type="text" class="form-control edit-charge-customer" data-reference="${reference}" value="${escapeModalValue(row.chargeToCustomer)}"></div>
                                    <div class="mb-2"><label class="form-label mb-1">Charge to Partner</label><input type="text" class="form-control edit-charge-partner" data-reference="${reference}" value="${escapeModalValue(row.chargeToPartner)}"></div>
                                    <div class="mb-2"><label class="form-label mb-1">Contact No</label><input type="text" class="form-control edit-contact-no" data-reference="${reference}" value="${escapeModalValue(row.contactNo)}"></div>
                                    <div class="mb-2"><label class="form-label mb-1">Other Details</label><input type="text" class="form-control edit-other-details" data-reference="${reference}" value="${escapeModalValue(row.otherDetails)}"></div>
                                    <div class="mb-2"><label class="form-label mb-1">ML Outlet</label><input type="text" class="form-control edit-ml-outlet" data-reference="${reference}" value="${escapeModalValue(row.mlOutlet)}"></div>
                                    <div class="mb-0"><label class="form-label mb-1">Operator</label><input type="text" class="form-control edit-operator" data-reference="${reference}" value="${escapeModalValue(row.operator)}"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        function extractSettlementRowData($row) {
            ...
            return {
                referenceNumber: $cells.eq(1).text().trim(),
        ...
        function collectSelectedRowsByReference() {
            ...
            $('#transactionReportTable tbody .row-select:checked').each(function () {
                ...
                if (rowData.referenceNumber) {
                    rowsByReference[rowData.referenceNumber] = rowData;
                }
            });
