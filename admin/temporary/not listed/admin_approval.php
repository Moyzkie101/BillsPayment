...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['confirmBtn'])) {
        ...
        $approvedSignature = '<span class="italic-text">electronically signed</span>';
...
<body>
   ...
   <div class="container">
      ...
      <center><h4>FOR APPROVE TRANSACTIONS</h4></center>
      <div class="data-table">
      <form action="" method="POST">
    <div class="approved-btn">
        <button type="submit" id="forapproved" class="approved" name="approved">For Approve</button>
    ...
    <table>
        ...
        <?php while ($row = mysqli_fetch_assoc($result)): ?>
            <?php if ($row['status'] !== 'Reviewed') continue; ?>
            <?php
 ...
 <div id="confirmModal" class="modal">
    ...
    <input type="hidden" id="cancelledBy" name="cancelledBy" value="<?php echo $_SESSION['admin_name'] ?>">
